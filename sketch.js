...
function preload()
{
  boy_img=loadImage("costume1.svg");
  tree_img=loadImage("Trre.png");
  bg_img = loadImage("winter.jpg");
  Sound = loadSound("bensound-rumble.mp3")
...
function setup() {
  ...
  thread=new constraint(stone1.body,{x:238,y:315-60});
...
function draw() {
  ...
  snowFall();
  imageMode(CENTER);
  image(boy_img,260+10,350-65,100-30,175-30);
